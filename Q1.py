...
def main():
    while True:
        ...
        if choice == '1':
            ...
            execution_time_log_path = 'Q1 result/SA1_execution_time_log_random.txt'
            sorted_data_path = 'Q1 result/SA1_sorted_book_data_random.txt'
            dataset_size = 100
            break
        elif choice == '2':
            file_path = 'data_nearly_sorted/data_nearly_sorted_100.xlsx'
            execution_time_log_path = 'Q1 result/SA1_execution_time_log_nearly_sorted.txt'
            sorted_data_path = 'Q1 result/SA1_sorted_book_data_nearly_sorted.txt'
            dataset_size = 100
            break
        elif choice == '3':
